...
<head>
    ...
    <title>Public Incident Reporting System - Notification</title>
        ...
        <nav>
            ...
            <div class="tabs">
                <div class="upper">
                    ...
                    <a href="notification.php" id="active">
    ...
    <script>
        function fetchNotifications() {
            fetch('php/fetch_notifications.php')
                ...
                .then(data => {
                    ...
                    <td class="action-box">
                        <a href="#" class="actionBtn read-btn" data-id="${notification.id}">Read</a>
                        <a href="#" class="actionBtn delete-btn" data-id="${notification.id}">Delete</a>
                    </td>
                `;
        ...
        document.addEventListener('click', function (event) {
            if (event.target.classList.contains('read-btn')) {
                ...
                fetch('php/mark_as_read.php', {
                    ...
                    .then(data => {
                        alert(data.message);
                        fetchNotifications(); // I-refresh ang notifications list
                    })
        ...
        document.addEventListener('click', function (event) {
            if (event.target.classList.contains('delete-btn')) {
                ...
                fetch('php/delete_notification.php', {
                    method: 'POST',
                    headers: { 'Content-Type': 'application/x-www-form-urlencoded' },
                    body: `id=${notifId}`
                })
        ...
        document.querySelectorAll('.dropdown-content a').forEach(option => {
            option.addEventListener('click', function (event) {
                event.stopPropagation();
                this.closest('.dropdown').classList.add('open');
            });
        });
